...
//TODO: Capire se questo può determinare il problema di lettura dell'ENCODER
...
#pragma config LVP = OFF         // Low-Voltage ICSP Enable bit (Low-voltage ICSP enabled) SE ABILITATO NON PUÒ ESSERE USATO CORRETTAMENTE RB5
